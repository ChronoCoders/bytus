      ...
      <div className="container mx-auto px-6 text-center">
        ...
        >
          ...
          <p className="text-muted-foreground text-lg mb-12">
            Experience the full power of Bytus on any device. Download our top-rated app today.
          </p>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="relative group">
              <Button variant="outline" className="h-16 px-6 border-2 hover:border-primary hover:bg-primary/5 transition-all w-full opacity-60 cursor-not-allowed">
                <div className="flex items-center gap-3 text-left">
                  <svg viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8 text-foreground transition-colors">
