  ...
  return (
    <div
      className={cn(
        ...
        // Variants
        variant === "silver" &&
          "bg-gradient-to-br from-gray-100 via-gray-300 to-gray-200 border border-blue-400/30",
        variant === "blue" &&
          "bg-gradient-to-br from-blue-600 via-blue-500 to-blue-700 text-white shadow-blue-900/20",
        variant === "dark" &&
        ...
        <div className="space-y-4 pt-10 sm:pt-14">
          ...
          <div className="flex justify-between items-end">
            ...
            <div className="space-y-1">
              <div
                className={cn(
                  "text-[9px] uppercase tracking-widest font-semibold opacity-60",
                  variant === "silver" || variant === "image"
                    ? "text-gray-600"
                    : "text-blue-100",
                )}
              ...
              <div
                className={cn(
                  "font-medium tracking-wider uppercase text-sm sm:text-base",
                  variant === "silver" || variant === "image"
                    ? "text-gray-800"
                    : "text-white",
                )}
